package org.entitiesproc.core.util
...
trait GeneratorConfig extends Config {
  ...
  protected final val ENTITIES_AMOUNT = s"$getConfigPrefix.entities-amount"
  ...
  def getEntitiesAmount: Int = getInt(ENTITIES_AMOUNT).getOrElse(100000)
...
$ENTITIES_AMOUNT: $getEntitiesAmount
